...
export const ITEM_TEMPLATES: ItemTemplate[] = [
  { key: 'potion', name: '回復ポーション', char: '!', color: '#f87171', kind: 'heal', power: 30, consumable: true },
  { key: 'greater-potion', name: '大回復ポーション', char: '!', color: '#f9a8d4', kind: 'heal', power: 60, consumable: true },
  ...
  { key: 'scroll', name: '電撃スクロール', char: '?', color: '#60a5fa', kind: 'scroll', power: 10, consumable: true },
];
